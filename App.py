...
with primary_input_column_left:
    primary_basic_salary = st.number_input("Input your monthly basic salary", min_value=0.0, value=3000.0, key="primary_b1")
    primary_allowances = st.number_input("Input your total monthly allowances", min_value=0.0, value=0.0, key="primary_a1")
    primary_bonus = st.number_input("Input your monthly bonuses", min_value=0.0, value=0.0, key="primary_bo1")
    
with primary_input_column_right:
    primary_overtime = st.number_input("Input your overtime earnings", min_value=0.0, value=0.0, key="primary_o1")
    primary_additional_deductions = st.number_input("Input any additional optional deductions", min_value=0.0, value=0.0, key="primary_d1")
...
primary_pocket_left_pane, primary_pocket_right_pane = st.columns(2)
...
primary_export_col_1, primary_export_col_2 = st.columns(2)
...
alternative_pocket_left_pane, alternative_pocket_right_pane = st.columns(2)
...
alternative_export_col_3, alternative_export_col_4 = st.columns(2)
